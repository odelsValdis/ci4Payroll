	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header bg-secondary text-white">
                Rekapitulasi Bunga Tabungan,Beban Adm.Bank,Pajak Tabungan
			</div>
			<div class="card-body">
...
var selectedRek;
var SERVICE_URL = '<?php echo base_url('api/mylibs/getHeaderTrreportAdm')?>';
var dataGrid;
...
function getType() {
    ...
    function processEdit(rowData){
        ...
        redirUrl = '<?php echo base_url('inputekadm/inputnew')?>'+"/"+idSekolah+"/"+idrek+"/"+idyear;
